        ...
        <div class="flex-center position-ref full-height">
                ...
                <div class="top-right links" style="background:blue;width:99%;height:50px;display: flex;justify-content: center;align-items: center;">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a style="color:white;font-size: 14pt;" href="{{ route('register') }}" title="Novo usuário">Criar conta</a>
                        @endif
                    @endauth
                </div>
            @endif
            ...
            <div class="content">
                ...
                <div style="color:black;font-weight:bold">
                    ...
                    Gerenciamento de Entregas <span class="fa fa-truck" aria-hidden="true"></span>
                </div>
            </div>
        </div>
    </body>
